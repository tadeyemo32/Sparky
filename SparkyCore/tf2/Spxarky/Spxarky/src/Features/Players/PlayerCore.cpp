...
void CPlayerlistCore::SavePlayerlist()
{
	...
	try
	{
		...
		SDK::Output("Spxarky", "Saved playerlist", DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Save playerlist failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
	}
}
...
void CPlayerlistCore::LoadPlayerlist()
{
	...
	try
	{
		...
		if (auto tSub = tRead.get_child_optional("Config"))
		{
			...
			SDK::Output("Spxarky", "Playerlist config not found", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		...
		if (auto tSub = tRead.get_child_optional("Tags"))
		{
			...
			SDK::Output("Spxarky", "Playerlist tags not found", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		...
		if (auto tSub = tRead.get_child_optional("Aliases"))
		{
			...
			SDK::Output("Spxarky", "Playerlist aliases not found", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);

		F::PlayerUtils.m_bLoad = false;
		SDK::Output("Spxarky", "Loaded playerlist", DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Load playerlist failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
	}
}