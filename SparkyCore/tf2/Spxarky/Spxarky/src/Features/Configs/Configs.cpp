...
CConfigs::CConfigs()
{
	m_sConfigPath = std::filesystem::current_path().string() + "\\Spxarky\\";
...
static inline void LoadMain(BaseVar*& pBase, boost::property_tree::ptree& tTree)
{
	...
	if (auto tMap = tTree.get_child_optional(pVar->Name()))
	{
		...
		SDK::Output("Spxarky", std::format("{} not found", pVar->Name()).c_str(), ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
}
...
bool CConfigs::SaveConfig(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("Spxarky", std::format("Config {} saved", sConfigName).c_str(), DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Save config failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		return false;
	}
...
bool CConfigs::LoadConfig(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (auto tSub = tRead.get_child_optional("Binds"))
		{
			...
			SDK::Output("Spxarky", "Config binds not found", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
			...
			tSub || (tSub = tRead.get_child_optional("ConVars")))
		{
			...
			SDK::Output("Spxarky", "Config vars not found", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		...
		if (auto tSub = tRead.get_child_optional("Groups"))
		{
			...
			SDK::Output("Spxarky", "Config groups not found", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		...
		m_sCurrentConfig = sConfigName; m_sCurrentVisuals = "";
		if (bNotify)
			SDK::Output("Spxarky", std::format("Config {} loaded", sConfigName).c_str(), DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Load config failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		return false;
	}
...
bool CConfigs::SaveVisual(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("Spxarky", std::format("Visual config {} saved", sConfigName).c_str(), DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Save visuals failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		return false;
	}
	return true;
}
...
bool CConfigs::LoadVisual(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("Spxarky", std::format("Visual config {} loaded", sConfigName).c_str(), DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Load visuals failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		return false;
	}
	return true;
}
...
void CConfigs::DeleteConfig(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("Spxarky", std::format("Config {} deleted", sConfigName).c_str(), DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Remove config failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
	}
}
...
void CConfigs::ResetConfig(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("Spxarky", std::format("Config {} reset", sConfigName).c_str(), DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Reset config failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
	}
}
...
void CConfigs::DeleteVisual(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("Spxarky", std::format("Visual config {} deleted", sConfigName).c_str(), DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Remove visuals failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
	}
}
...
void CConfigs::ResetVisual(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("Spxarky", std::format("Visual config {} reset", sConfigName).c_str(), DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Spxarky", "Reset visuals failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
	}
}