...
MAKE_SIGNATURE(CTFInput_CAM_CapYaw, XS("client.dll"), XS("40 53 48 83 EC ? 0F 29 74 24 ? 0F 28 F1"), 0x0);
MAKE_SIGNATURE(CTFInput_ApplyMouse, XS("client.dll"), XS("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC ? 0F 29 74 24 ? 49 8B E8"), 0x0);
MAKE_SIGNATURE(CTFPlayerShared_CalculateChargeCap, XS("client.dll"), XS("48 83 EC ? 4C 8B 81 ? ? ? ? 48 8D 15"), 0x0);
