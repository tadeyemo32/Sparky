...
MAKE_SIGNATURE(CBasePlayer_ItemPostFrame, XS("client.dll"), XS("48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8B 39 48 8B F1 FF 97"), 0x0);
MAKE_SIGNATURE(GetAnimationEvent, XS("server.dll"), XS("48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 0F 29 74 24 ? 0F 28 F3 49 8B F0"), 0x0);
