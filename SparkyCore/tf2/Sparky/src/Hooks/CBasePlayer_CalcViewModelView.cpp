...
MAKE_SIGNATURE(CBaseViewModel_CalcViewModelView, XS("client.dll"), XS("48 89 74 24 ? 55 41 56 41 57 48 8D AC 24"), 0x0);
MAKE_SIGNATURE(CBasePlayer_CalcViewModelView, XS("client.dll"), XS("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC ? 49 8B F0 48 8B EA 48 8B F9 33 DB"), 0x0);
