...
MAKE_SIGNATURE(GetClientInterpAmount, XS("client.dll"), XS("40 53 48 83 EC ? 8B 05 ? ? ? ? A8 ? 75 ? 48 8B 0D ? ? ? ? 48 8D 15"), 0x0);
MAKE_SIGNATURE(CNetGraphPanel_DrawTextFields_GetClientInterpAmount_Call1, XS("client.dll"), XS("48 8B 05 ? ? ? ? 4C 8D 05 ? ? ? ? F3 44 0F 10 0D"), 0x0);
MAKE_SIGNATURE(CNetGraphPanel_DrawTextFields_GetClientInterpAmount_Call2, XS("client.dll"), XS("48 8B 05 ? ? ? ? F3 0F 10 48 ? F3 0F 5E C1"), 0x0);
