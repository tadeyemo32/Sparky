...
MAKE_SIGNATURE(COPRenderSprites_Render, XS("client.dll"), XS("48 89 54 24 ? 55 53 57 41 55 41 56"), 0x0);
MAKE_SIGNATURE(COPRenderSprites_RenderSpriteCard, XS("client.dll"), XS("48 8B C4 48 89 58 ? 57 41 54"), 0x0);
MAKE_SIGNATURE(COPRenderSprites_RenderTwoSequenceSpriteCard, XS("client.dll"), XS("48 8B C4 48 89 58 ? 48 89 68 ? 56 57 41 54 41 56 41 57 48 81 EC ? ? ? ? F3 0F 10 1D"), 0x0);
    ...
    void* rcx, IMatRenderContext* pRenderContext, CParticleCollection* pParticles, void* pContext)
{
    ...
    {
    // blue icons
    case FNV1A::Hash32Const(XS("effects\\defense_buff_bullet_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\defense_buff_explosion_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\defense_buff_fire_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_agility_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_haste_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_king_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_knockout_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_plague_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_precision_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_reflect_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_resist_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_strength_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_supernova_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_thorns_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_vampire_icon_blue.vmt")):
    {
    ...
    // red icons
    case FNV1A::Hash32Const(XS("effects\\defense_buff_bullet_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\defense_buff_explosion_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\defense_buff_fire_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_agility_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_haste_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_king_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_knockout_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_plague_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_precision_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_reflect_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_regen_icon_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_regen_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_resist_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_strength_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_supernova_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_thorns_icon_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\powerup_vampire_icon_red.vmt")):
    {
        auto pLocal = H::Entities.GetLocal();
    ...
    */
    case FNV1A::Hash32Const(XS("effects\\particle_nemesis_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\particle_nemesis_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\particle_nemesis_burst.vmt")):
    case FNV1A::Hash32Const(XS("effects\\duel_blue.vmt")):
    case FNV1A::Hash32Const(XS("effects\\duel_red.vmt")):
    case FNV1A::Hash32Const(XS("effects\\duel_burst.vmt")):
    case FNV1A::Hash32Const(XS("effects\\crit.vmt")):
    case FNV1A::Hash32Const(XS("effects\\yikes.vmt")):
        bValid = true;
    }
    if (!bValid)
        return CALL_ORIGINAL(rcx, pRenderContext, pParticles, pContext);
