...
MAKE_SIGNATURE(CM_BoxTrace, XS("engine.dll"), XS("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56 48 83 EC ? 45 0F B6 F1"), 0x0);
MAKE_SIGNATURE(CM_ClipBoxToBrush_True, XS("engine.dll"), XS("48 89 5C 24 ? 57 48 81 EC ? ? ? ? 44 0F B7 42"), 0x0);
MAKE_SIGNATURE(CM_ClipBoxToBrush_False, XS("engine.dll"), XS("48 8B C4 48 89 58 ? 57 48 81 EC ? ? ? ? 44 0F B7 42"), 0x0);
MAKE_SIGNATURE(CEngineTrace_ClipTraceToTrace, XS("engine.dll"), XS("48 89 5C 24 ? 57 48 83 EC ? 80 7A ? ? 49 8B D8"), 0x0);
