...
MAKE_SIGNATURE(NotificationQueue_Add, XS("client.dll"), XS("48 89 5C 24 ? 57 48 83 EC ? 48 8B F9 48 8B 0D ? ? ? ? 48 8B 01 FF 90 ? ? ? ? 84 C0 75"), 0x0);
	...
	CEconNotification* pNotification)
{
	...
	if (Vars::Misc::Automation::AcceptItemDrops.Value && FNV1A::Hash32(pNotification->m_pText) == FNV1A::Hash32Const(XS("TF_HasNewItems")))
	{
