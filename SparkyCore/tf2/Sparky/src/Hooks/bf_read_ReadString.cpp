...
MAKE_SIGNATURE(bf_read_ReadString, XS("client.dll"), XS("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56 40 32 FF"), 0x0);
MAKE_SIGNATURE(CHudVote_MsgFunc_VoteStart_ReadString_Call, XS("client.dll"), XS("8B 4B ? 8B C1 44 8B 5B ? 41 2B C3 83 F8 ? 7D ? 89 4B ? 48 8B CB E8 ? ? ? ? 41 8B C6"), 0x0);
