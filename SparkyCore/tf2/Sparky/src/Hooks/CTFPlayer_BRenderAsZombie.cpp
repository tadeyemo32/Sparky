...
MAKE_SIGNATURE(CTFPlayer_BRenderAsZombie, XS("client.dll"), XS("48 89 5C 24 ? 57 48 83 EC ? 48 8B D9 B9 ? ? ? ? E8 ? ? ? ? 84 C0"), 0x0);
MAKE_SIGNATURE(CTFRagdoll_CreateTFRagdoll_BRenderAsZombie_Call, XS("client.dll"), XS("84 C0 74 ? C6 87 ? ? ? ? ? 48 8B 06"), 0x0);
