...
bool CEntities::IsHealth(uint32_t uHash)
{
	switch (uHash)
	{
	case FNV1A::Hash32Const(XS("models/items/banana/plate_banana.mdl")):
	case FNV1A::Hash32Const(XS("models/items/medkit_small.mdl")):
	case FNV1A::Hash32Const(XS("models/items/medkit_medium.mdl")):
	case FNV1A::Hash32Const(XS("models/items/medkit_large.mdl")):
	case FNV1A::Hash32Const(XS("models/items/medkit_small_bday.mdl")):
	case FNV1A::Hash32Const(XS("models/items/medkit_medium_bday.mdl")):
	case FNV1A::Hash32Const(XS("models/items/medkit_large_bday.mdl")):
	case FNV1A::Hash32Const(XS("models/items/plate.mdl")):
	case FNV1A::Hash32Const(XS("models/items/plate_sandwich_xmas.mdl")):
	case FNV1A::Hash32Const(XS("models/items/plate_robo_sandwich.mdl")):
	case FNV1A::Hash32Const(XS("models/props_medieval/medieval_meat.mdl")):
	case FNV1A::Hash32Const(XS("models/workshopweapons/c_models/c_chocolate/plate_chocolate.mdl")):
	case FNV1A::Hash32Const(XS("models/workshopweapons/c_models/c_fishcake/plate_fishcake.mdl")):
	case FNV1A::Hash32Const(XS("models/props_halloween/halloween_medkit_small.mdl")):
	case FNV1A::Hash32Const(XS("models/props_halloween/halloween_medkit_medium.mdl")):
	case FNV1A::Hash32Const(XS("models/props_halloween/halloween_medkit_large.mdl")):
	case FNV1A::Hash32Const(XS("models/items/ld1/mushroom_large.mdl")):
	case FNV1A::Hash32Const(XS("models/items/plate_steak.mdl")):
	case FNV1A::Hash32Const(XS("models/props_brine/foodcan.mdl")):
		return true;
	}
	return false;
}
...
bool CEntities::IsAmmo(uint32_t uHash)
{
	switch (uHash)
	{
	case FNV1A::Hash32Const(XS("models/items/ammopack_small.mdl")):
	case FNV1A::Hash32Const(XS("models/items/ammopack_medium.mdl")):
	case FNV1A::Hash32Const(XS("models/items/ammopack_large.mdl")):
	case FNV1A::Hash32Const(XS("models/items/ammopack_large_bday.mdl")):
	case FNV1A::Hash32Const(XS("models/items/ammopack_medium_bday.mdl")):
	case FNV1A::Hash32Const(XS("models/items/ammopack_small_bday.mdl")):
		return true;
	}
	return false;
}
...
bool CEntities::IsPowerup(uint32_t uHash)
{
	switch (uHash)
	{
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_agility.mdl")):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_crit.mdl")):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_defense.mdl")):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_haste.mdl")):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_king.mdl")):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_knockout.mdl")):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_plague.mdl")):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_precision.mdl")):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_reflect.mdl")):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_regen.mdl")):
	//case FNV1A::Hash32Const("models/pickups/pickup_powerup_resistance.mdl"):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_strength.mdl")):
	//case FNV1A::Hash32Const("models/pickups/pickup_powerup_strength_arm.mdl"):
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_supernova.mdl")):
	...
	case FNV1A::Hash32Const(XS("models/pickups/pickup_powerup_vampire.mdl")):
		return true;
	}
	return false;
}
...
bool CEntities::IsSpellbook(uint32_t uHash)
{
	switch (uHash)
	{
	case FNV1A::Hash32Const(XS("models/props_halloween/hwn_spellbook_flying.mdl")):
	case FNV1A::Hash32Const(XS("models/props_halloween/hwn_spellbook_upright.mdl")):
	case FNV1A::Hash32Const(XS("models/props_halloween/hwn_spellbook_upright_major.mdl")):
	case FNV1A::Hash32Const(XS("models/items/crystal_ball_pickup.mdl")):
	case FNV1A::Hash32Const(XS("models/items/crystal_ball_pickup_major.mdl")):
	case FNV1A::Hash32Const(XS("models/props_monster_mash/flask_vial_green.mdl")):
	case FNV1A::Hash32Const(XS("models/props_monster_mash/flask_vial_purple.mdl")): // prop_dynamic in the map, probably won't work
		return true;
	}
	return false;
}
