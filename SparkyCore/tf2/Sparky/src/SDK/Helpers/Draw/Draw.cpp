...
MAKE_SIGNATURE(CHudBaseDeathNotice_GetIcon, XS("client.dll"), XS("40 53 48 81 EC ? ? ? ? 48 8B DA"), 0x0);
MAKE_SIGNATURE(RenderLine, XS("engine.dll"), XS("48 89 5C 24 ? 48 89 74 24 ? 44 89 44 24"), 0x0);
MAKE_SIGNATURE(RenderBox, XS("engine.dll"), XS("48 83 EC ? 8B 84 24 ? ? ? ? 4D 8B D8"), 0x0);
MAKE_SIGNATURE(RenderWireframeBox, XS("engine.dll"), XS("48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 55 41 54 41 55 41 56 41 57 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 49 8B F9"), 0x0);
MAKE_SIGNATURE(RenderWireframeSweptBox, XS("engine.dll"), XS("48 8B C4 48 89 58 ? 48 89 50 ? 48 89 48 ? 55 56 57 41 54 41 55 41 56 41 57 48 8D A8 ? ? ? ? 48 81 EC ? ? ? ? 0F 29 70"), 0x0);
MAKE_SIGNATURE(RenderTriangle, XS("engine.dll"), XS("48 83 EC ? 41 8B C1 44 88 4C 24"), 0x0);
MAKE_SIGNATURE(RenderSphere, XS("engine.dll"), XS("48 8B C4 44 89 48 ? F3 0F 11 48"), 0x0);
