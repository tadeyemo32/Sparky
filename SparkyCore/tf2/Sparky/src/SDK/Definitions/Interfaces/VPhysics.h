...
MAKE_INTERFACE_VERSION(IPhysicsCollision, PhysicsCollision, XS("vphysics.dll"), XS("VPhysicsCollision007"));
...
MAKE_INTERFACE_VERSION(IPhysics, Physics, XS("vphysics.dll"), XS("VPhysics031"));