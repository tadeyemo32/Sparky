...
MAKE_SIGNATURE(CPrediction_RestoreEntityToPredictedFrame, XS("client.dll"), XS("40 55 48 83 EC ? 8B EA"), 0x0);
...
MAKE_INTERFACE_VERSION(CPrediction, Prediction, XS("client.dll"), XS("VClientPrediction001"));