...
MAKE_SIGNATURE(CBaseClientState_SendStringCmd, XS("engine.dll"), XS("48 81 EC ? ? ? ? 48 8B 49"), 0x0);
...
MAKE_INTERFACE_SIGNATURE(CClientState, ClientState, XS("engine.dll"), XS("48 8D 0D ? ? ? ? E8 ? ? ? ? F3 0F 5E 05"), 0x0, 0);