...
MAKE_SIGNATURE(ClientModeTFNormal_BIsFriendOrPartyMember, XS("client.dll"), XS("48 89 5C 24 ? 57 48 81 EC ? ? ? ? 48 85 D2 0F 84"), 0x0);
...
MAKE_INTERFACE_SIGNATURE(CClientModeShared, ClientModeShared, XS("client.dll"), XS("48 8B 0D ? ? ? ? 48 8B 10 48 8B 19 48 8B C8 FF 92"), 0x0, 1);