...
MAKE_SIGNATURE(CMatSystemSurface_StartDrawing, XS("vguimatsurface.dll"), XS("40 53 56 57 48 83 EC ? 48 8B F9 80 3D"), 0x0);
MAKE_SIGNATURE(CMatSystemSurface_FinishDrawing, XS("vguimatsurface.dll"), XS("40 53 48 83 EC ? 33 C9"), 0x0);
...
MAKE_INTERFACE_VERSION(IMatSystemSurface, MatSystemSurface, XS("vguimatsurface.dll"), XS("VGUI_Surface030"));