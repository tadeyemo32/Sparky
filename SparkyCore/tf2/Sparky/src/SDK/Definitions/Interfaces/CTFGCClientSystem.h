...
MAKE_SIGNATURE(CGCClientSharedObjectCache_FindTypeCache, XS("client.dll"), XS("48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 0F B7 59 ? BE"), 0x0);

MAKE_SIGNATURE(CTFGCClientSystem_PingThink, XS("client.dll"), XS("40 55 41 54 41 55 48 8D AC 24"), 0x0);
MAKE_SIGNATURE(CTFGCClientSystem_UpdateAssignedLobby, XS("client.dll"), XS("40 55 53 41 54 41 56 41 57 48 8B EC"), 0x0);
MAKE_SIGNATURE(CTFGCClientSystem_GetParty, XS("client.dll"), XS("48 83 EC ? 48 8B 89 ? ? ? ? 48 85 C9 74 ? BA ? ? ? ? E8 ? ? ? ? 48 85 C0 74 ? 8B 48 ? 85 C9 74 ? 48 8B 40 ? FF C9"), 0x0);

MAKE_SIGNATURE(CTFParty_SpewDebug, XS("client.dll"), XS("4C 8B DC 41 56 48 81 EC ? ? ? ? 8B 05"), 0x0);
...
MAKE_INTERFACE_SIGNATURE(CTFGCClientSystem, TFGCClientSystem, XS("client.dll"), XS("48 8D 05 ? ? ? ? C3 CC CC CC CC CC CC CC CC 48 8B 05 ? ? ? ? C3 CC CC CC CC CC CC CC CC 48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24"), 0x0, 0);