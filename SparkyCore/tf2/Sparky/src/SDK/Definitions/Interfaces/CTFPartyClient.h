...
MAKE_SIGNATURE(CTFPartyClient_SendPartyChat, XS("client.dll"), XS("48 89 5C 24 ? 48 89 6C 24 ? 57 48 83 EC ? 48 C7 C3"), 0x0);
MAKE_SIGNATURE(CTFPartyClient_LoadSavedCasualCriteria, XS("client.dll"), XS("48 83 79 ? ? C6 81 ? ? ? ? ? 74 ? 80 79 ? ? 74 ? C6 81 ? ? ? ? ? 48 8B 15"), 0x0);
MAKE_SIGNATURE(CTFPartyClient_BInQueueForMatchGroup, XS("client.dll"), XS("48 89 5C 24 ? 57 48 83 EC ? 48 8B F9 8B DA 8B CA E8 ? ? ? ? 84 C0"), 0x0);
MAKE_SIGNATURE(CTFPartyClient_RequestQueueForMatch, XS("client.dll"), XS("40 55 56 48 81 EC ? ? ? ? 48 63 F2"), 0x0);
MAKE_SIGNATURE(CCasualCriteriaHelper_CCasualCriteriaHelper, XS("client.dll"), XS("48 89 5C 24 ? 56 57 41 57 48 83 EC ? 0F 57 C0"), 0x0);
MAKE_SIGNATURE(CTFGroupMatchCriteriaProto_DefaultInstance, XS("client.dll"), XS("48 8B 05 ? ? ? ? 48 8B 50 ? 48 8D 4C 24 ? E8 ? ? ? ? 44 8B 44 24"), 0x0);
