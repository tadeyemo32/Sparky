...
int CBaseEntity::GetHitboxToBase(int nHitbox)
{
	...
	{
	case FNV1A::Hash32Const(XS("models/bots/engineer/bot_engineer.mdl")):
		switch (nHitbox)
		{
		...
		break;
	case FNV1A::Hash32Const(XS("models/vsh/player/saxton_hale.mdl")):
	case FNV1A::Hash32Const(XS("models/vsh/player/hell_hale.mdl")):
	case FNV1A::Hash32Const(XS("models/vsh/player/santa_hale.mdl")):
		switch (nHitbox)
		{
		...
		break;
	case FNV1A::Hash32Const(XS("models/player/scout_infected.mdl")):
	case FNV1A::Hash32Const(XS("models/player/soldier_infected.mdl")):
	case FNV1A::Hash32Const(XS("models/player/sniper_infected.mdl")):
		switch (nHitbox)
		{
		...
		break;
	case FNV1A::Hash32Const(XS("models/player/pyro_infected.mdl")):
		switch (nHitbox)
		{
		...
		break;
	case FNV1A::Hash32Const(XS("models/player/demo_infected.mdl")):
		switch (nHitbox)
		{
		...
		break;
	case FNV1A::Hash32Const(XS("models/player/heavy_infected.mdl")):
		switch (nHitbox)
		{
		...
		break;
	case FNV1A::Hash32Const(XS("models/player/engineer_infected.mdl")):
		switch (nHitbox)
		{
		...
		break;
	case FNV1A::Hash32Const(XS("models/player/medic_infected.mdl")):
		switch (nHitbox)
		{
		...
		break;
	case FNV1A::Hash32Const(XS("models/player/spy_infected.mdl")):
		switch (nHitbox)
		{
