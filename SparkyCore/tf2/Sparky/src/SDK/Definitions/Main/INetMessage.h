...
public:
	...
	const char* GetName() const { return XS("clc_Move"); }
...
public:
	...
	const char* GetName() const { return XS("net_SetConVar"); }
	void* m_pMessageHandler;
...
public:
	...
	const char* GetName() const { return XS("net_SignonState"); }
	void* m_pMessageHandler;
...
public:
	...
	const char* GetName() const { return XS("net_Tick"); }
	void* m_pMessageHandler;
...
public:
	...
	const char* GetName() const { return XS("clc_VoiceData"); }
	void* m_pMessageHandler;
...
public:
	...
	const char* GetName() const { return XS("clc_RespondCvarValue"); }
	void* m_pMessageHandler;
...
public:
	...
	const char* GetName() const { return XS("clc_BaselineAck"); }
	void* m_pMessageHandler;
