...
MAKE_SIGNATURE(CCollisionProperty_SetCollisionBounds, XS("client.dll"), XS("48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56 48 81 EC ? ? ? ? F3 0F 10 0A"), 0x0);
MAKE_SIGNATURE(CCollisionProperty_CalcNearestPoint, XS("client.dll"), XS("48 89 5C 24 ? 57 48 83 EC ? 49 8B D8 48 8B F9 4C 8D 44 24"), 0x0);
