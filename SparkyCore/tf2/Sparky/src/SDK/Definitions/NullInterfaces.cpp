...
MAKE_SIGNATURE(Get_TFPartyClient, XS("client.dll"), XS("48 8B 05 ? ? ? ? C3 CC CC CC CC CC CC CC CC 48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56"), 0x0);
MAKE_SIGNATURE(Get_SteamNetworkingUtils, XS("client.dll"), XS("40 53 48 83 EC ? 48 8B D9 48 8D 15 ? ? ? ? 33 C9 FF 15 ? ? ? ? 33 C9"), 0x0);
...
bool CNullInterfaces::Initialize()
{
	...
	I::KeyValuesSystem = U::Memory.GetModuleExport<IKeyValuesSystem*(*)()>(XS("vstdlib.dll"), XS("KeyValuesSystem"))();
