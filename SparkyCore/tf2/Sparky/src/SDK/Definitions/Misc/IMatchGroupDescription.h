...
MAKE_SIGNATURE(IProgressionDesc_GetLevelByNumber, XS("client.dll"), XS("83 EA ? 4C 8B C1"), 0x0);
MAKE_SIGNATURE(CTFRatingData_GetRatingData, XS("client.dll"), XS("8B 41 ? 89 02 8B 41 ? 89 42 ? 8B 41 ? 89 42 ? 48 8B C2"), 0x0);
MAKE_SIGNATURE(CTFRatingData_YieldingGetPlayerRatingDataBySteamID, XS("client.dll"), XS("48 89 5C 24 ? 57 48 83 EC ? 8B FA 48 8B D9 E8 ? ? ? ? 48 8B C8"), 0x0);
